...
import {ColumnModel, CourseModel} from '@models/core';
...
import {CoursesHttpService} from "@servicesHttp/core";
...
export class CourseListComponent implements OnInit {
  ...
  private readonly courseHttpServices = inject(CoursesHttpService);
  ...
  protected selectedItem: CourseModel = {};
  protected items: CourseModel[] = [];
  ...
  findAll() {
    this.courseHttpServices.findAll().subscribe((response) => {
      this.items = response;
    });
  }
