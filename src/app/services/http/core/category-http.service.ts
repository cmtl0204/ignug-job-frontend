...
import {CategoryModule} from '@models/core';
...
export class CategoryHttpService {
  ...
  create(payload: CategoryModule): Observable<CategoryModule> {
  ...
  findOne(id: string): Observable<CategoryModule> {
  ...
  update(id: string, payload: CategoryModule): Observable<CategoryModule> {
    const url = `${this.API_URL}/${id}`;
